    ...
    <div class="container bg-dark p-5 mt-5">
        <div class="form-group">
            <label class="text-white"
                >Add a category <span style="color: red">ONLY IF</span> there
                are no entries from the
                <span style="color: green">Category</span> section below!</label
            >
            <div
                v-bind:class="{
            ...
            <div class="mb-3">
                ...
                />
                <button class="btn btn-success mt-3" @click="addCatbtn">
                    Add
                </button>
            </div>
